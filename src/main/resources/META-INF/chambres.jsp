...
<head>
  ...
  <title>Chambres - ZK Grandeur Hôtel</title>
</head>
<body>
...
<section class="container my-5">
  <h2 class="text-center luxury-title mb-4">Nos Chambres Luxueuses</h2>

  <div class="row">
    <!-- Première Chambre -->
    <div class="col-lg-4 mb-3">
      <div class="card h-100">
        <img src="images/patrick-robert-doyle-AH8zKXqFITA-unsplash.jpg" class="card-img-top" alt="Chambre 1">
        <div class="card-body">
          <h5 class="card-title">Chambre Deluxe</h5>
          <p class="card-text">Description de la Chambre Deluxe avec des détails captivants.</p>
          <a href="#" class="btn btn-custom">Découvrir</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 mb-3">
      <div class="card h-100">
        <img src="images/2.jpg" class="card-img-top" alt="Chambre 2">
        <div class="card-body">
          <h5 class="card-title">Suite Royale</h5>
          <p class="card-text">Description de la Suite Royale avec une ambiance luxueuse.</p>
          <a href="#" class="btn btn-custom">Découvrir</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 mb-3">
      <div class="card h-100">
        <img src="images/3.jpg" class="card-img-top" alt="Chambre 3">
        <div class="card-body">
          <h5 class="card-title">Suite Panoramique</h5>
          <p class="card-text">Découvrez une vue imprenable dans notre Suite Panoramique.</p>
          <button class="btn btn-custom" data-bs-toggle="modal" data-bs-target="#modalChambreDeluxe">Découvrir</button>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 mb-3">
      <div class="card h-100">
        <img src="images/4.jpg" class="card-img-top" alt="Chambre 4">
        <div class="card-body">
          <h5 class="card-title">Suite Luxury</h5>
          <p class="card-text">Découvrez une vue imprenable dans notre Suite Luxury.</p>
          <a href="#" class="btn btn-custom">Découvrir</a>
        </div>
      </div>
    </div>
